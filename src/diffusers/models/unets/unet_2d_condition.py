...
class UNet2DConditionModel(
    ...
    def forward(
        ...
        is_blobnet = down_block_add_samples is not None and mid_block_add_sample is not None and up_block_add_samples is not None
        ...
        if is_blobnet:
            if sample.shape[-1] == sample.shape[-2]:
                ...
                sample[..., -sample.shape[-2]:] = sample[..., -sample.shape[-2]:] + down_block_add_samples.pop(0)
        ...
        for downsample_block in self.down_blocks:
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                ...
                if is_blobnet and len(down_block_add_samples)>0:
        ...
        if is_blobnet:
            if sample.shape[-1] == sample.shape[-2]:
                ...
                sample[..., -sample.shape[-2]:] = sample[..., -sample.shape[-2]:] + mid_block_add_sample
        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            if hasattr(upsample_block, "has_cross_attention") and upsample_block.has_cross_attention:
                additional_residuals = {}
                if is_blobnet and len(up_block_add_samples)>0:
