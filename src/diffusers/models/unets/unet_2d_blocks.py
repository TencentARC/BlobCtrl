...
def get_down_block(
    ...
    if down_block_type == "DownBlock2D":
        ...
        if cross_attention_dim is None:
            logger.warning("cross_attention_dim is not specified for CrossAttnDownBlock2D, cross attention will not be used")
        ...
        if cross_attention_dim is None:
            logger.warning("cross_attention_dim is not specified for SimpleCrossAttnDownBlock2D, cross attention will not be used")
...
def get_up_block(
    ...
    if up_block_type == "UpBlock2D":
        ...
        if cross_attention_dim is None:
            logger.warning("cross_attention_dim is not specified for CrossAttnUpBlock2D, cross attention will not be used")
        ...
        if cross_attention_dim is None:
            logger.warning("cross_attention_dim is not specified for SimpleCrossAttnUpBlock2D, cross attention will not be used")
        ...
        for i, (resnet, attn) in enumerate(blocks):
            ...
            if down_block_add_samples is not None:
                if hidden_states.shape[-1] == hidden_states.shape[-2]:
                    ...
                    hidden_states[..., -hidden_states.shape[-2]:] = hidden_states[..., -hidden_states.shape[-2]:] + down_block_add_samples.pop(0)
        ...
        for resnet, attn in zip(self.resnets, self.attentions):
            ...
            if up_block_add_samples is not None:
                if hidden_states.shape[-1] == hidden_states.shape[-2]:
                    ...
                    hidden_states[..., -hidden_states.shape[-2]:] = hidden_states[..., -hidden_states.shape[-2]:] + up_block_add_samples.pop(0)
